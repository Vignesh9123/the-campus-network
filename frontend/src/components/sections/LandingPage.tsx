    ...
    >
      ...
      />
            <div className="lg:w-1/2 p-5">
              ...
              <Link to={isLoading ? "#" : user ? "/profile" : "/login"} className="px-5 md:px-8 py-2 md:w-1/3  flex justify-center rounded-full bg-gradient-to-b from-blue-500 to-blue-600 text-white focus:ring-2 focus:ring-blue-400 hover:shadow-xl transition duration-200">
                <User className='mr-2'/>{isLoading ? <div className="animate-spin h-5 w-5 border-b-2 border-white rounded-full"></div> : user ? "Profile" : "Login"}
